...
echo "<form action='user.php' method='post' class='mb-3'>";
...
if(isset($_POST['searchBtn']) && $_POST['search'] != NULL){
  ...
  $selectsql = "SELECT * FROM user_table WHERE user_id LIKE '%$searchinput%' OR full_name LIKE '%$searchinput%' OR role LIKE '%$searchinput%' 
  OR username LIKE '%$searchinput%' OR password LIKE '%$searchinput%' OR email LIKE '%$searchinput%'";
} else {
  $selectsql = "SELECT * FROM user_table";
}
...
if ($result->num_rows > 0) {
    ...
    echo "<th class='table-custom text-white'> Full Name </th>";
    echo "<th class='table-custom text-white'> Role </th>";
    echo "<th class='table-custom text-white'> Username </th>";
    echo "<th class='table-custom text-white'> Password </th>";
    echo "<th class='table-custom text-white'> Email </th>";
    ...
    echo "<td class='table-custom-1'>".$fields['full_name']."</td>";
    echo "<td class='table-custom-1'>".$fields['role']."</td>";
    echo "<td class='table-custom-1'>".$fields['username']."</td>";
    echo "<td class='table-custom-1'>".$fields['password']."</td>";
    echo "<td class='table-custom-1'>".$fields['email']."</td>";

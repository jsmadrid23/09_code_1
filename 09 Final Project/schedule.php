...
$selectsql= "SELECT * FROM schedule_table";

echo "<div class='container mt-5'>";
echo "<form action='schedule.php' method='post' class='mb-3'>";
...
if(isset($_POST['searchBtn']) && $_POST['search'] != NULL){
  ...
  $selectsql = "SELECT * FROM schedule_table WHERE schedule_id LIKE '%$searchinput%' OR bus_id LIKE '%$searchinput%' OR route_id LIKE '%$searchinput%' 
  OR departure_date LIKE '%$searchinput%' OR departure_time LIKE '%$searchinput%' OR available_seats LIKE '%$searchinput%'";
} else {
  $selectsql = "SELECT * FROM schedule_table";
}
...
if ($result->num_rows > 0) {
    ...
    echo "<th class='table-custom text-white'> Departure Date </th>";
    echo "<th class='table-custom text-white'> Departure Time </th>";
    echo "<th class='table-custom text-white'> Available Seats </th>";
    ...
    echo "<td class='table-custom-1'>".$fields['departure_date']."</td>";
    echo "<td class='table-custom-1'>".$fields['departure_time']."</td>";
    echo "<td class='table-custom-1'>".$fields['available_seats']."</td>";

    ...
    <div class="wrapper">
        <aside id="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="route.php" class="sidebar-link active">
...
$selectsql= "SELECT * FROM route_table";

echo "<div class='container mt-5'>";
echo "<form action='route.php' method='post' class='mb-3'>";
...
if(isset($_POST['searchBtn']) && $_POST['search'] != NULL){
  ...
  $selectsql = "SELECT * FROM route_table WHERE route_id LIKE '%$searchinput%' OR route_name LIKE '%$searchinput%' OR departure_location LIKE '%$searchinput%' 
  OR destination LIKE '%$searchinput%' OR distance LIKE '%$searchinput%' OR duration LIKE '%$searchinput%'";
} else {
  $selectsql = "SELECT * FROM route_table";
}
...
if ($result->num_rows > 0) {
    ...
    echo "<tr>";
    echo "<th class='table-custom text-white'> Route ID </th>";
    echo "<th class='table-custom text-white'> Route Name </th>";
    ...
    echo "<tr>";
    echo "<td class='table-custom-1'>".$fields['route_id']."</td>";
    echo "<td class='table-custom-1'>".$fields['route_name']."</td>";

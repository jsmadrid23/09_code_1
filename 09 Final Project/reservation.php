    ...
    <div class="wrapper">
        <aside id="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="reservation.php" class="sidebar-link active">
...
$selectsql= "SELECT * FROM reservation_table";

echo "<div class='container mt-5'>";
echo "<form action='reservation.php' method='post' class='mb-3'>";
...
if(isset($_POST['searchBtn']) && $_POST['search'] != NULL){
  ...
  $selectsql = "SELECT * FROM reservation_table WHERE reservation_id LIKE '%$searchinput%' OR schedule_id LIKE '%$searchinput%' OR passenger_name LIKE '%$searchinput%' 
  OR contact_information LIKE '%$searchinput%' OR seat_number LIKE '%$searchinput%' OR reservation_date LIKE '%$searchinput%' OR status LIKE '%$searchinput%'";
} else {
  $selectsql = "SELECT * FROM reservation_table";
}
...
if ($result->num_rows > 0) {
    ...
    echo "<tr>";
    echo "<th class='table-custom text-white'>  </th>";
    echo "<th class='table-custom text-white'> Reservation ID </th>";
    echo "<th class='table-custom text-white'> Schedule ID </th>";
    echo "<th class='table-custom text-white'> Passenger Name </th>";
    echo "<th class='table-custom text-white'> Contact Information </th>";
    echo "<th class='table-custom text-white'> Seat Number </th>";
    echo "<th class='table-custom text-white'> Reservation Date </th>";
    echo "<th class='table-custom text-white'> Status </th>";
    echo "<th class='table-custom text-white'> Action </th>";
    echo "</tr>";
    //fetch_assoc() - fetch all records inside table
    while ($fields=$result-> fetch_assoc()) {
    echo "<tr>";
    echo "<td class='table-custom-1'>".$fields['reservation_id']."</td>";
    echo "<td class='table-custom-1'>".$fields['schedule_id']."</td>";
    echo "<td class='table-custom-1'>".$fields['passenger_name']."</td>";
    echo "<td class='table-custom-1'>".$fields['contact_information']."</td>";
    echo "<td class='table-custom-1'>".$fields['seat_number']."</td>";
    echo "<td class='table-custom-1'>".$fields['reservation_date']."</td>";
    echo "<td class='table-custom-1'>".$fields['status']."</td>";

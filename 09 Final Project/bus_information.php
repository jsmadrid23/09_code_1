    ...
    <div class="wrapper">
        <aside id="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="bus_information.php" class="sidebar-link active">
...
$selectsql= "SELECT * FROM bus_table";


echo "<div class='container mt-5'>";
echo "<form action='bus_information.php' method='post' class='mb-3'>";
...
if(isset($_POST['searchBtn']) && $_POST['search'] != NULL){
  ...
  $selectsql = "SELECT * FROM bus_table WHERE bus_id LIKE '%$searchinput%' OR bus_number LIKE '%$searchinput%' OR seating_capacity LIKE '%$searchinput%' OR driver_name LIKE '%$searchinput%'
  OR departure_location LIKE '%$searchinput%' OR destination LIKE '%$searchinput%' OR distance LIKE '%$searchinput%' OR duration LIKE '%$searchinput%'";
} else {
  $selectsql = "SELECT * FROM bus_table";
}
...
if ($result->num_rows > 0) {
    ...
    echo "<tr>";
    echo "<th class='table-custom text-white'> Bus ID </th>";
    echo "<th class='table-custom text-white'> Bus Number </th>";
    echo "<th class='table-custom text-white'> Seating Capacity </th>";
    echo "<th class='table-custom text-white'> Driver Name </th>";
    echo "<th class='table-custom text-white'> Departure Location </th>";
    echo "<th class='table-custom text-white'> Destination </th>";
    echo "<th class='table-custom text-white'> Distance </th>";
    echo "<th class='table-custom text-white'> Duration </th>";
    echo "<th class='table-custom text-white'> Action </th>";
    echo "</tr>";
    //fetch_assoc() - fetch all records inside table
    while ($fields=$result-> fetch_assoc()) {
    echo "<tr>";
    echo "<td class='table-custom-1'>".$fields['bus_id']."</td>";
    echo "<td class='table-custom-1'>".$fields['bus_number']."</td>";
    echo "<td class='table-custom-1'>".$fields['seating_capacity']."</td>";
    echo "<td class='table-custom-1'>".$fields['driver_name']."</td>";
    echo "<td class='table-custom-1'>".$fields['departure_location']."</td>";
    echo "<td class='table-custom-1'>".$fields['destination']."</td>";
    echo "<td class='table-custom-1'>".$fields['distance']."</td>";
    echo "<td class='table-custom-1'>".$fields['duration']."</td>";
